            ...
            <nav class="navbar navbar-light  pt-3 pb-3">
                <div class="container">
                    <?php if (session()->get('isLoggedIn')) : ?>
                        <a class="text-white" href="<?= site_url('dashboard') ?>">LOGO</a>
                    <?php else : ?>
                        <a class="text-white" href="<?= site_url('/') ?>">LOGO</a>
                    <?php endif; ?>

                    <?php if (session()->get('isLoggedIn')) : ?>
                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-outline-light btn-dark1 justify-content-end" id="btn-dark1"><img
